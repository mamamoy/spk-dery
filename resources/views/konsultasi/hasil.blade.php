                ...
                <div class="col-12 wow fadeInUp" data-wow-delay=".2s">
                    <div class="single-service text-start">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control-plaintext" id="nama" value=""
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control-plaintext" id="usia" value=""
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control-plaintext" id="jenis_kelamin" value=""
